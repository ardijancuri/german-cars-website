...
import { Brush, CheckCircle, Award } from 'lucide-react'
import SEO from '../../components/SEO'

const benefits = [
  'Professionelle Lackaufbereitung',
  'Hochglanzpolitur & Swirl-Entfernung',
  'Glanzoptimierung & Farbvertiefung',
  'Lackversiegelung für langanhaltenden Schutz',
  'Entfernung von Oxidation & Verwitterung',
  'Farbauffrischung für neuwertigen Glanz',
]

const packages = [
  {
    name: 'Basic Politur',
    description: 'Auffrischung & Glanz',
    features: [
      'Handwäsche',
      'Ein-Stufen-Politur',
      'Swirl-Entfernung (leicht)',
      'Versiegelung',
    ],
  },
  {
    name: 'Premium Politur',
    description: 'Intensive Lackkorrektur',
    features: [
      'Basic Politur +',
      'Zwei-Stufen-Politur',
      'Kratzerentfernung (mittel)',
      'Lackversiegelung Premium',
      'Felgenpolitur',
    ],
  },
  {
    name: 'Ultimate',
    description: 'Vollständige Lackveredelung',
    features: [
      'Premium Politur +',
      'Drei-Stufen-Politur',
      'Tiefenkratzer-Korrektur',
      'Keramik-Finish',
...
export default function PaintFinishing() {
  return (
    <div className="pt-20">
      <SEO
        title="Lackveredelung - Professionelle Lackaufbereitung"
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Brush style={{ height: '20px', width: '20px', color: '#ffffff' }} />
              </div>
              <span
                style={{
                  color: '#E54B1E',
            ...
            >
              ...
              <span className="gradient-text">Lackveredelung</span>
            </h1>
            <p
              style={{
            ...
            >
              Bringen Sie Ihren Lack zum Strahlen. Mit mehrstufiger Politur und professioneller
              Versiegelung verleihen wir Ihrem Fahrzeug neuwertigen Glanz.
            </p>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Wählen Sie das passende Lackveredelungs-Paket für Ihr Fahrzeug.
            </p>
          </motion.div>
